...
void JobLoadCharacter2::Execute()
{
	g_theDevConsole->AddLine( Rgba8::ORANGE, "not loading mesh data" );

	//g_theCharacter->LoadMeshData();
}


void GameFixCameraIdleTurn::Startup()
{
...
//----------------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::DeferedStartupAfterLoadingAnimationData()
{
	...
	g_theJobSystem->PostNewJob( new JobLoadCharacter2() );
}


//-------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::DeferedStartupAfterLoadingMeshData()
{
...
//----------------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::Shutdown()
{
	delete m_player;
...
//----------------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::Update()
{
...
//----------------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::Render() const
{
...
//----------------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::PrintDebugScreenMessage()
{
	float fontSize = 15.f;
...
//----------------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::CreateObstacle()
{
...
//----------------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::RenderObstacle() const
{
...
//----------------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::InitLightConstants()
{
...
//----------------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::UpdateLightConstants()
{
...
//-------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::StartLoadAnimationData()
{
...
//-------------------------------------------------------------------------------------------------
void GameFixCameraIdleTurn::UpdateLoadedAnimationData()
{
	if ( m_isAllAnimationDataLoaded && m_isAllMeshDataLoaded )
		return;
	...
	for (auto iter = completedJobs.begin(); iter != completedJobs.end(); iter++)
	{
		...
		{
			JobLoadCharacter2* loadCharacterCompleted = dynamic_cast<JobLoadCharacter2*>(completedJob);
